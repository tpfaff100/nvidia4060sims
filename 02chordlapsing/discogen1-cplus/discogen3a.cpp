...
./discogen3a                              # defaults: length 5, kick 1.0x
./discogen3a out.wav 48000 0 5 1.0        # normal kick
./discogen3a out.wav 48000 0 5 1.5        # noticeably punchier
./discogen3a out.wav 48000 0 5 2.0        # twice as loud
./discogen3a out.wav 48000 42 7 2.5       # longer song, heavy kick
*/
...
int main(int argc,char**argv)
{
    ...
    printf("SEED: %u   LENGTH: %d/10   KICK: %.1fx\n",seed,length,kickBoost);
    printf("(rerun './discogen out.wav %d %u %d %.1f')\n\n",sr,seed,length,kickBoost);
