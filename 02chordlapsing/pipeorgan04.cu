/* 	pipeorgan01 out.wav 48000 0 5 2.0 0.5   :: Gothic cathedral, RT60 ~6s, IR 5.5s
	pipeorgan01 out.wav 48000 0 5 3.0 0.4   :: Vast nave, RT60 ~8s, IR 7.5s
	pipeorgan01 out.wav 48000 0 5 4.0 0.3   :: Basilica scale, RT60 ~10s, IR 9.5s
	pipeorgan01 out.wav 48000 0 5 5.0 0.2   :: Hagia Sophia, RT60 ~11.5s, IR 11.5s
*/
...
int main(int argc,char**argv)
{
    ...
    subsonicHPF(hL,totalSamples,(float)sr);   /* linear — no distortion    */
    subsonicHPF(hR,totalSamples,(float)sr);   /* writeWav normalises peak  */
    printf("Writing WAV...\n");fflush(stdout);
